...
| :------: | :-------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   `db`   | <code>[SQLAlchemyProxy](../flask_sa_api/SQLAlchemyProxy.mdx){`[flask_sqlalchemy_lite.SQLAlchemy, _ModelLite]`}</code> | <p>The SQLAlchemy extension instance. In run time, it is the same as the returned value of [`get_flask_sqlalchemy`](./get_flask_sqlalchemy.mdx).</p><p>However, this returned value is always notated by `SQLAlchemyLiteProxy`, which provides the notations of the behaviors when `flask_sqlalchemy` is absent.</p> |
