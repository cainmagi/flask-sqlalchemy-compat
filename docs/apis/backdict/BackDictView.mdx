...
| `back_data`  | `Mapping[K2, T]` | <InlineIcon icon={vsiCheckIcon}/> | <p>Backup immutable data internal storage of `BackDict`.</p>                     |
| `key_mapper` |   `(K) -> K2`    | <InlineIcon icon={vsiCheckIcon}/> |
