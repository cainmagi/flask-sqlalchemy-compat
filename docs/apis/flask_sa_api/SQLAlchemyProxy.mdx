...
| `back_data` |    `_ModelLite_co`     | <InlineIcon icon={vsiCheckIcon}/> | <p>The type of the base model. This `model_class` is mandatory.</p><p>It needs to be used for providing the functionalities related to the metadata.</p>                                                                                                            |
