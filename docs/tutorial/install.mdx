...
| :--------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   `test`   | Install the dependencies related to [`pytest`][link-pytest]. These dependencies are not used by the package but used by the unittests. This tier already includes `example`. |
...
| Python version | <center>`flask-sqlalchemy-lite`</center> | <center>`flask-sqlalchemy`</center> | <center>`flask-sqlalchemy-compat-backend-py37`</center> |
| :------------: | :--------------------------------------: | :---------------------------------: | :-----------------------------------------------------: |
