...
const variables = {
  ...
  sourceURIs: {
    main: {
      ...
      "backends.conditional_import": "backends.py#L146",
      "backends.is_module_invalid": "backends.py#L163",
      "backends.BackendProxy": "backends.py#L188",
      "backends.proxy": "backends.py#L255",
      flask_sa_api: "flask_sa_api.py",
      "flask_sa_api.SQLAlchemyProxy": "flask_sa_api.py#L74",
      "flask_sa_api.as_flask_sqlalchemy": "flask_sa_api.py#L541",
